	...
	*/
	...
	private void updateMiddleList()
	{
		...
		for(Cluster cluster : allCluster)
		{
			...
			x += widthElement +20;
			//�berpr�fung ob das element reinpasst in die zeile noch
			//wenn ja alle elemente des clusters adden
			//wenn nicht n�chste zeile beginnen
			if(x  > 3*einheitX) 
			{
				x = 5;
			...
			public boolean processGestureEvent(MTGestureEvent ge) {
				...
				{		
					...
					for(MTComponent selectedComponent : clickedCell.getChildren())
					{
						...
						//Popup muss aufgehen f�r weitere Ideen
						...
						if (g instanceof DragEvent){
							...
							case MTGestureEvent.GESTURE_ENDED:
								...
								if (dragTarget instanceof MTTextArea){
									...
									{			
										boolean added = false;
										//�berpr�fung ob der cluster bereits besteht
